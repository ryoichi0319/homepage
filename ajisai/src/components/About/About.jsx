  ...
  return (
    <div className='about'>
      <div className='company-greeting'>
       ...
       <p className='company-text'>当社はtext text text text text text text text text<br /> text text text
       text text text text text texttext text <br />text text text texttext text text text text texttext text text text text text</p>
      </div>
